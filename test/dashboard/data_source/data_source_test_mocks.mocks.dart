...
// in wemolo_parking/test/dashboard/data_source/data_source_test_mocks.dart.
...
import 'package:wemolo_parking/core/network/models/network_response.dart'
    as _i7;
import 'package:wemolo_parking/core/network/network_service.dart' as _i11;
...
class _FakeNetworkResponse_5<Model1> extends _i1.SmartFake
    implements _i7.NetworkResponse<Model1> {
  _FakeNetworkResponse_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockNetworkService extends _i1.Mock implements _i11.NetworkService {
  ...
  @override
  void addBasicAuth(String? accessToken) => super.noSuchMethod(
        Invocation.method(
          #addBasicAuth,
          [accessToken],
        ),
  ...
  @override
  _i9.Future<_i7.NetworkResponse<Model>> execute<Model>(
    _i11.NetworkRequest? request, {
    _i2.ProgressCallback? onSendProgress,
    _i2.ProgressCallback? onReceiveProgress,
  }) =>
      (super.noSuchMethod(
        ...
        returnValue: _i9.Future<_i7.NetworkResponse<Model>>.value(
            _FakeNetworkResponse_5<Model>(
          this,
          Invocation.method(
            #execute,
            [request],
      ...
      ) as _i9.Future<_i7.NetworkResponse<Model>>);

  @override
  _i9.Future<_i7.NetworkResponse<T>> delete<T>({
    ...
    Map<String, dynamic>? queryParams,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i9.Future<_i7.NetworkResponse<T>>.value(_FakeNetworkResponse_5<T>(
          this,
          Invocation.method(
            #delete,
            [],
  ...
  @override
  _i9.Future<_i7.NetworkResponse<T>> get<T>({
    required String? path,
    Map<String, dynamic>? queryParams,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i9.Future<_i7.NetworkResponse<T>> patch<T>({
    required String? path,
    dynamic requestBody,
    Map<String, dynamic>? queryParams,
  }) =>
  ...
  @override
  _i9.Future<_i7.NetworkResponse<T>> put<T>({
    required String? path,
    dynamic requestBody,
    Map<String, dynamic>? queryParams,
  }) =>
